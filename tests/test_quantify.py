...
def test_quantify_single_timepoint_3D_no_parent(_ensure_test_data):
    ...
    assert res_obj2.count().label == 100
    assert list(np.unique(res_obj2.Object2_3D_area)) == [2.0**3]
...
def test_quantify_single_timepoint_3D_intensity_channels_str_input(_ensure_test_data):
    ...
    assert list(np.unique(res_obj2_intensity1_str_input.Object2_3D_intensity_min_Channel1)) == [
        0,
        1000.0,
        2000.0,
        3000.0,
...
def test_quantify_single_timepoint_3D_intensity_channels_list1_str_input(_ensure_test_data):
    ...
    assert list(np.unique(res_obj2_intensity1_list1_str_input.Object2_3D_intensity_min_Channel1)) == [
        0,
        1000.0,
        2000.0,
        3000.0,
...
def test_quantify_single_timepoint_3D_intensity_channels_list2_str_input(_ensure_test_data):
    ...
    assert list(np.unique(res_obj2_intensity1_list2_str_input.Object2_3D_intensity_min_Channel2)) == [5000.0, 6000.0]
...
def test_quantify_single_timepoint_3D_intensity_channels_list_int_input(_ensure_test_data):
    ...
    assert list(np.unique(res_obj2_intensity1_list_int_input.Object2_3D_intensity_min_Channel1)) == [
        0,
        1000.0,
        2000.0,
        3000.0,
    ...
    assert list(np.unique(res_obj2_intensity1_list_int_input.Object2_3D_intensity_min_Channel2)) == [5000.0, 6000.0]
